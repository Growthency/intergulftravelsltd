  ...
  return (
    <Section className="bg-sand-soft">
      <SectionHeading
        ...
        title={<>Trusted by thousands of <span className="text-gradient">happy pilgrims</span></>}
        ...
        <div className="relative rounded-[2rem] border border-border bg-card p-8 shadow-soft sm:p-12">
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button onClick={() => go(-1)} aria-label="Previous" className="grid h-11 w-11 place-items-center rounded-full border border-border text-brand-700 transition hover:bg-brand-50">
                <ChevronLeft className="h-5 w-5" />
              </button>
              <button onClick={() => go(1)} aria-label="Next" className="grid h-11 w-11 place-items-center rounded-full border border-border text-brand-700 transition hover:bg-brand-50">
